...
const projects = [
  ...
  // if there are no projects, Projects section won't show up
  {
    ...
    sourceCode: 'https://github.com/Nikhil170404/RiseUnderdog.io',
...

  {
    name: 'ServePro',
    description:
      'I have built ServePro, a web application using ReactJS and Firebase, where clients can explore services, book them seamlessly, and make secure online payments. The site features easy navigation, user-friendly design, and efficient contact options. Firebase handles authentication, real-time database, and payment processing, ensuring a smooth and reliable experience.',
    stack: ['REACT','FIREBASE','MATERIAL UI'],
    sourceCode: 'https://github.com/Nikhil170404/Servepro',
    livePreview: "https://nikhil170404.github.io/Servepro/",
  },
